...
//            LittleUtils.updateOpenid();;
            ...
            return LittleUtils.setRespMsg(100, "Success", "暂无开启的签到");
        }
        String s = null;
        try {
...
//            LittleUtils.updateOpenid();
            ...
            return littleUtils.setRespMsg(100, "Success", "暂无需要观看的课件");
        }
...
//            littleUtils.updateOpenid();
            ...
            return littleUtils.setRespMsg(100, "Success", "暂无需要提交的课堂反馈");
        }
