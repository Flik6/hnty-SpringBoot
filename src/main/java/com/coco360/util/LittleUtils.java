...
//                System.out.println(line);
    ...
    /**
     * 通过注册表获得微信路径 返回微信注册表内map键值对
     * @param param 微信注册表内key的参数
     * @return  微信注册表内key对应的value
...
//                System.out.println(line);
     ...
     * 编辑图片
     * @param path  图片路径
     * @param list  根据传入的list参数信息 需要在那个xy坐标添加什么文字
     * @return  修改图片后的BufferedImage类型的图片
     * @throws IOException
